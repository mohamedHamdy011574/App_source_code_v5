...
class SplashParser {
  ...
  void saveBasicInfo(var currencyCode, var currencySide, var currencySymbol, var smsName, var verifyWith, var userLogin, var supportEmail, var appName, var shipping, var shippingPrice, var tax,
      var appLogo, var supportName, var supportId, var supportPhone, var allowDistance) {
