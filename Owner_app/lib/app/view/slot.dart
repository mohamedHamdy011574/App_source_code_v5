                      ...
                      (index) => Column(
                        ...
                        children: [
                          Container(
                            ...
                            decoration: const BoxDecoration(border: Border(bottom: BorderSide(color: ThemeProvider.greyColor), top: BorderSide(color: ThemeProvider.greyColor))),
                            child: Padding(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Row(
                                      ...
                                      children: [
                                        InkWell(
                                          onTap: () => value.onEdit(value.slotList[index].id as int),
                                          child: const Icon(Icons.edit_note, color: ThemeProvider.greenColor),
                                        ),
                                        InkWell(
                                          onTap: () {
                                            showDialog(
                                          ...
                                          child: const Icon(Icons.delete, color: ThemeProvider.redColor),
                                        ),
                                      ],
                                    ),
                                  ),
