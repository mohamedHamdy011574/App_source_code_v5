                            ...
                            children: [
                              value.savedCategories.isEmpty
                                  ? Column(
                                      ...
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [Text('Select Categories'.tr, style: const TextStyle(fontSize: 17))])
                                  : Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: List.generate(
                                        ...
                                        (name) => Column(
                                          children: [Text(value.savedCategories[name].toString(), style: const TextStyle(fontSize: 17))],
                                        ),
                                      ),
                                    ),
                                  ...
                                  children: [
                                    value.savedSpecialist.isEmpty
                                        ? Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [Text('Select Specialist'.tr, style: const TextStyle(fontSize: 17))])
                                        : Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: List.generate(
                                              ...
                                              (firstName) => Row(
                                                children: [Text(value.savedSpecialist[firstName].toString(), style: const TextStyle(fontSize: 17))],
                                              ),
                                            ),
                                          ),
                                    const Icon(Icons.chevron_right, color: ThemeProvider.greyColor),
              ...
              ? Padding(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [Text('ADD PACKAGES'.tr, style: const TextStyle(color: ThemeProvider.whiteColor, fontSize: 17))],
                      ),
                    ),
                  ),
                )
              : Padding(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [Text('UPDATE PACKAGES'.tr, style: const TextStyle(color: ThemeProvider.whiteColor, fontSize: 17))],
                      ),
                    ),
                  ),
                ),
