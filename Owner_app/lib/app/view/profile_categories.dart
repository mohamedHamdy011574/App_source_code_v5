                          ...
                          children: [
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: List.generate(
                                            ...
                                            (index) => Column(
                                              children: [Text(value.profileInfo.webCatesData![index].name.toString(), style: const TextStyle(fontSize: 17))],
                                            ),
                                          ),
                                        ),
                                ...
                                child: InkWell(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          value.profileInfo.cityData!.name.toString() == '' || value.profileInfo.cityData!.name!.isEmpty ? 'Select'.tr : value.profileInfo.cityData!.name.toString(),
                            ...
                            Padding(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text('Have Multiple Stylist ?'.tr, style: const TextStyle(fontSize: 14)),
                                  Switch(
