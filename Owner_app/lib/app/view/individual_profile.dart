                          ...
                          Container(
                            ...
                            child: FadeInImage(
                              ...
                              imageErrorBuilder: (context, error, stackTrace) {
                                return Image.asset('assets/images/notfound.png', fit: BoxFit.cover, height: 300, width: double.infinity);
                              },
                              fit: BoxFit.cover,
                              height: 300,
                              width: double.infinity,
                                ...
                                children: [
                                  ...
                                  CircleAvatar(
                                    ...
                                    child: IconButton(
                                      ...
                                      icon: const Icon(Icons.edit, color: ThemeProvider.whiteColor),
                                    ),
                                  ),
                                ],
                              ),
                        ...
                        child: Column(
                          children: [
                            Padding(
                              ...
                              child: Container(
                                width: double.infinity,
                                decoration: BoxDecoration(borderRadius: BorderRadius.circular(10.0), border: Border.all(color: ThemeProvider.appColor, style: BorderStyle.solid)),
                                child: InkWell(
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: List.generate(
                                            ...
                                            (index) => Column(
                                              children: [Text(value.individualInfo.webCatesData![index].name.toString(), style: const TextStyle(fontSize: 17))],
                                            ),
                                          ),
                                        ),
                              ...
                              child: SizedBox(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: const BorderSide(color: ThemeProvider.appColor)),
                            ...
                            Padding(
                              padding: const EdgeInsets.symmetric(vertical: 10),
                              child: Container(
                                decoration: BoxDecoration(borderRadius: BorderRadius.circular(100.0), border: Border.all(color: ThemeProvider.appColor, style: BorderStyle.solid)),
                                child: InkWell(
                            ...
                            Padding(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text('Have Popular ?'.tr, style: const TextStyle(fontSize: 14)),
                                  Switch(value: value.havePopular, onChanged: (bool status) => value.updatePopular(status), activeColor: ThemeProvider.greenColor),
                                ],
                              ),
                            ),
                            Padding(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text('Have Shop ?'.tr, style: const TextStyle(fontSize: 14)),
                                  Switch(value: value.haveShop, onChanged: (bool status) => value.updateShop(status), activeColor: ThemeProvider.greenColor),
                                ],
                              ),
                            ),
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Switch(value: value.haveHome, onChanged: (bool status) => value.updateHome(status), activeColor: ThemeProvider.greenColor),
                                ],
                              ),
                            ),
                            const SizedBox(height: 30),
                                          ...
                                          children: [
                                            ...
                                            SizedBox(
                                              ...
                                              child: ElevatedButton(
                                                ...
                                                onPressed: () {
                                                  value.onEditTime(
                                                      value.getDayName(value.timesList[index].day as int), value.timesList[index].openTime.toString(), value.timesList[index].closeTime.toString());
                                                },
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text('SUBMIT'.tr, style: const TextStyle(color: ThemeProvider.whiteColor, fontSize: 17)),
                  ],
                ),
              ),
            ),
