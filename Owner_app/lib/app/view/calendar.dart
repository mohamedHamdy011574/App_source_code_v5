      ...
      builder: (value) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text('Calendar'.tr, style: const TextStyle(fontFamily: 'bold', fontSize: 14, color: ThemeProvider.whiteColor)),
            bottom: value.apiCalled == true
                ? PreferredSize(preferredSize: const Size.fromHeight(300), child: Container(child: _getAgendaViewCalendar(value.events, _onViewChanged, _calendarController)))
                : null,
          ),
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  value.appointmentList[index].items!.services!.isNotEmpty
                                                      ? Text('Services'.tr, overflow: TextOverflow.ellipsis, style: const TextStyle(fontFamily: 'bold', fontSize: 12, color: ThemeProvider.blackColor))
                                                      : const SizedBox(),
                                                  ...
                                                  value.appointmentList[index].items!.packages!.isNotEmpty
                                                      ? Text('Packages'.tr, overflow: TextOverflow.ellipsis, style: const TextStyle(fontFamily: 'bold', fontSize: 12, color: ThemeProvider.blackColor))
                                                      : const SizedBox(),
                                                  Column(
                                                    crossAxisAlignment: CrossAxisAlignment.start,
                                                    mainAxisAlignment: MainAxisAlignment.start,
                            ...
                            : Center(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text('No Appointment Found!'.tr, style: const TextStyle(fontFamily: 'bold', color: ThemeProvider.appColor)),
                                  ],
                                ),
                              ),
                      ),
