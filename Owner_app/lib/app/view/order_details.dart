                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('${value.appointmentInfo.userInfo!.firstName} ${value.appointmentInfo.userInfo!.lastName}',
                                      overflow: TextOverflow.ellipsis, style: const TextStyle(fontFamily: 'bold', fontSize: 14)),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(child: Text('Service At'.tr, overflow: TextOverflow.ellipsis, style: const TextStyle(color: ThemeProvider.appColor, fontFamily: 'bold', fontSize: 15))),
                            ],
                          ),
                        ),
                        Padding(
                        ...
                        Padding(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: [
                              Expanded(child: Text('Booking Date & Time'.tr, overflow: TextOverflow.ellipsis, style: const TextStyle(color: ThemeProvider.appColor, fontFamily: 'bold', fontSize: 15))),
                            ],
                          ),
                        ),
                        Column(
                          children: [
                            Row(
                              ...
                              children: [
                                Expanded(child: Text('Booking Date'.tr, overflow: TextOverflow.ellipsis, style: const TextStyle(color: ThemeProvider.blackColor, fontSize: 15))),
                                Expanded(
                                  child: Text(
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Expanded(child: Text('Booking Time'.tr, overflow: TextOverflow.ellipsis, style: const TextStyle(color: ThemeProvider.blackColor, fontSize: 15))),
                                Expanded(
                                  child: Text(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    value.currencySide == 'left' ? value.currencySymbol + value.appointmentInfo.discount.toString() : value.appointmentInfo.discount.toString() + value.currencySymbol,
                                    overflow: TextOverflow.ellipsis,
                                    textAlign: TextAlign.end,
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    value.currencySide == 'left' ? value.currencySymbol + value.appointmentInfo.total.toString() : value.appointmentInfo.total.toString() + value.currencySymbol,
                                    overflow: TextOverflow.ellipsis,
                                    textAlign: TextAlign.end,
                                    style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 15),
                                  ),
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Expanded(child: Text('Payment'.tr, overflow: TextOverflow.ellipsis, style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 15))),
                                Expanded(
                                  child: Text(
