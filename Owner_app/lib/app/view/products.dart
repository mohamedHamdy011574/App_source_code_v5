            ...
            actions: [
              Padding(
                ...
                child: TextButton(
                  ...
                  onPressed: () => value.onCreateProducts(),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          Expanded(child: Text(item.name.toString(), overflow: TextOverflow.ellipsis, style: const TextStyle(fontFamily: 'bold', fontSize: 14))),
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.end,
                                            children: [
                                              InkWell(
                                                onTap: () => value.updateStatus(item.id as int, item.status as int),
                                                child: Icon(item.status == 1 ? Icons.visibility : Icons.visibility_off, color: item.status == 1 ? ThemeProvider.greenColor : ThemeProvider.blackColor),
                                              ),
                                              const SizedBox(width: 5),
                                              InkWell(
                                                onTap: () => value.onUpdateProducts(item.id as int),
                                                child: const Icon(Icons.edit_note, color: ThemeProvider.appColor),
                                              ),
                                              const SizedBox(width: 5),
                                              InkWell(
                                                onTap: () {
