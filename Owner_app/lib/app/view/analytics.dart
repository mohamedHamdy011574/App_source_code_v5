...
class _AnalyticScreenState extends State<AnalyticScreen> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AnalyticsController>(builder: (value) {
      Map<int, Widget> myTabs = <int, Widget>{
        0: Text("Daily".tr, style: TextStyle(color: Get.find<AnalyticsController>().segmentedControlGroupValue == 0 ? ThemeProvider.whiteColor : ThemeProvider.blackColor)),
      ...
      Map<int, Widget> myTabsProducts = <int, Widget>{
        0: Text("Daily".tr, style: TextStyle(color: Get.find<AnalyticsController>().segmentedControlGroupValueProducts == 0 ? ThemeProvider.whiteColor : ThemeProvider.blackColor)),
        1: Text("Monthly".tr, style: TextStyle(color: Get.find<AnalyticsController>().segmentedControlGroupValueProducts == 1 ? ThemeProvider.whiteColor : ThemeProvider.blackColor)),
        2: Text("Yearly".tr, style: TextStyle(color: Get.find<AnalyticsController>().segmentedControlGroupValueProducts == 2 ? ThemeProvider.whiteColor : ThemeProvider.blackColor)),
      };
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            bottom: TabBar(
              ...
              tabs: [Text('Appointment'.tr, style: const TextStyle(color: ThemeProvider.whiteColor)), Text('Products Order'.tr, style: const TextStyle(color: ThemeProvider.whiteColor))],
            ),
          ),
          body: TabBarView(
            children: [
              SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    Container(alignment: Alignment.topLeft, child: Text('Earnings'.tr, style: const TextStyle(fontSize: 18, fontFamily: 'medium', color: ThemeProvider.blackColor))),
                    const SizedBox(height: 20),
                    SizedBox(
                      width: double.infinity,
                      child: CupertinoSlidingSegmentedControl(
                          groupValue: value.segmentedControlGroupValue, children: myTabs, thumbColor: ThemeProvider.appColor, onValueChanged: (i) => value.updateSegments(i as int)),
                    ),
                    const SizedBox(height: 20),
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: Text('Earnings'.tr, style: const TextStyle(fontSize: 18, fontFamily: 'medium', color: ThemeProvider.blackColor)),
                    ),
                    const SizedBox(height: 20),
                    SizedBox(
                      width: double.infinity,
  ...
  SfCartesianChart _buildChart() {
    return SfCartesianChart(
      ...
      primaryYAxis: NumericAxis(axisLine: const AxisLine(width: 0), labelFormat: '{value}${Get.find<AnalyticsController>().currencySymbol}', majorTickLines: const MajorTickLines(size: 0)),
      series: _getWeekData(),
      tooltipBehavior: _tooltipBehavior,
    );
  }
