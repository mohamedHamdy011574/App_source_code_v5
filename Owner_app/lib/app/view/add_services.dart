                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('Status'.tr, style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 14)),
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      Text(value.selectedStatus == 1 ? 'Available'.tr : 'Hide'.tr, style: const TextStyle(fontSize: 17)),
                                      const Icon(Icons.expand_more, color: ThemeProvider.greyColor),
                                    ],
                                  ),
                                ],
