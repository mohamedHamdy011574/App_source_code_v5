                                ...
                                return value.gallery[index] == ''
                                    ? GestureDetector(
                                        ...
                                        child: Container(
                                          height: 100,
                                          width: 100,
                                          decoration: BoxDecoration(border: Border.all(color: ThemeProvider.greyColor), borderRadius: const BorderRadius.all(Radius.circular(5))),
                                          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [const Icon(Icons.add), const SizedBox(height: 10), Text('Upload Image'.tr)]),
                                        ),
                                      )
                                    : Stack(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text('Update Images'.tr, style: const TextStyle(color: ThemeProvider.whiteColor, fontSize: 17)),
                  ],
                ),
              ),
            ),
