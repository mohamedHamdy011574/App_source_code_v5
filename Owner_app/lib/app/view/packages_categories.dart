                                        ...
                                        children: [
                                          Positioned(
                                            ...
                                            child: Checkbox(
                                              ...
                                              onChanged: (status) => value.updateStatus(status!, value.servicesList[i].id as int),
                                            ),
                                          ),
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              Text('${value.servicesList[i].duration} min', overflow: TextOverflow.ellipsis, style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 12)),
                                            ],
                                          ),
                                        ],
                                      ),
