                    ...
                    child: Column(
                      children: [
                            ...
                            child: SizedBox.fromSize(
                              ...
                              child: FadeInImage(
                                ...
                                imageErrorBuilder: (context, error, stackTrace) {
                                  return Image.asset('assets/images/notfound.png', fit: BoxFit.cover, height: 70, width: 70);
                                },
                                fit: BoxFit.cover,
                                height: 70,
                                width: 70,
                        ...
                        Padding(
                          ...
                          child: Container(
                            decoration: BoxDecoration(borderRadius: BorderRadius.circular(5.0), border: Border.all(color: Colors.grey, style: BorderStyle.solid)),
                            child: InkWell(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text('Categories'.tr, style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 14)),
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        value.selectedCateName == ''
                                            ? Text('Select Categories'.tr, style: const TextStyle(fontSize: 17))
                                            : Text(value.selectedCateName, style: const TextStyle(fontSize: 17)),
                                        const Icon(Icons.expand_more, color: ThemeProvider.greyColor),
                                      ],
                                    ),
                                  ],
                                ),
                            ...
                            child: InkWell(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('Select Subcategories'.tr, style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 14)),
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        value.selectedSubName == ''
                                            ? Text('Sub Categories'.tr, style: const TextStyle(fontSize: 17))
                                            : Text(value.selectedSubName, style: const TextStyle(fontSize: 17)),
                                        const Icon(Icons.expand_more, color: ThemeProvider.greyColor),
                                      ],
                                    ),
                                  ],
                            ...
                            child: InkWell(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('in Offers'.tr, style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 14)),
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        Text(value.selectedOfferStatus == 1 ? 'Available'.tr : 'Hide'.tr, style: const TextStyle(fontSize: 17)),
                                        const Icon(Icons.expand_more, color: ThemeProvider.greyColor),
                                      ],
                                    ),
                                  ],
                            ...
                            child: InkWell(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('in Stock'.tr, style: const TextStyle(color: ThemeProvider.greyColor, fontSize: 14)),
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        Text(value.selectedStackStatus == 1 ? 'Available'.tr : 'Hide'.tr, style: const TextStyle(fontSize: 17)),
                                        const Icon(Icons.expand_more, color: ThemeProvider.greyColor),
                                      ],
                                    ),
                                  ],
                        ...
                        Padding(padding: const EdgeInsets.symmetric(vertical: 10), child: Row(children: [Text('Upload More Image'.tr, style: const TextStyle(fontFamily: 'bold', fontSize: 14))])),
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text('Expired Date'.tr, style: const TextStyle(fontSize: 16)),
                                  Text('${value.expDate.day}/${value.expDate.month}/${value.expDate.year}', style: const TextStyle(fontSize: 16)),
                                ],
                              ),
                            ),
                          ),
            ...
            child: value.type == 'create'
                ? InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [Text('SUBMIT'.tr, style: const TextStyle(color: ThemeProvider.whiteColor, fontSize: 17))]),
                    ),
                  )
                : InkWell(
                    ...
                    child: Container(
                      width: double.infinity,
                      padding: const EdgeInsets.symmetric(vertical: 13.0),
                      decoration: const BoxDecoration(color: ThemeProvider.greenColor, borderRadius: BorderRadius.all(Radius.circular(100.0))),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [Text('UPDATE'.tr, style: const TextStyle(color: ThemeProvider.whiteColor, fontSize: 17))],
                      ),
                    ),
                  ),
          ),
