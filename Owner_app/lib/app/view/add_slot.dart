      ...
      builder: (value) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            elevation: 0,
            toolbarHeight: 50,
            title: Text('Add Slots'.tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.start, style: ThemeProvider.titleStyle),
          ),
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    Chip(
                                      ...
                                      label: Text('${value.slotList[index].startTime} to ${value.slotList[index].endTime}', style: const TextStyle(fontFamily: 'regular')),
                                    ),
                                    Positioned(
                                      right: -10,
                                      child: InkWell(
                                        ...
                                        child: const SizedBox(
                                          height: 20,
                                          width: 20,
                                          child: CircleAvatar(backgroundColor: ThemeProvider.redColor, child: Icon(Icons.close, color: ThemeProvider.whiteColor, size: 15)),
                                        ),
                                      ),
                                    )
                                  ],
                ...
                Expanded(
                  child: Container(
                    ...
                    child: InkWell(
                      ...
                      child: Center(
                        child: Text('Save & Submit'.tr, style: const TextStyle(fontFamily: 'bold', color: ThemeProvider.whiteColor)),
                      ),
                    ),
                  ),
                ),
