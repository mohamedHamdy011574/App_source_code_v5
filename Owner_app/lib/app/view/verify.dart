                    ...
                    child: value.divNumber == 1
                        ? Column(
                            children: [
                              Padding(
                                ...
                                child: Row(children: [Text('Forgot Password ?'.tr, style: const TextStyle(color: ThemeProvider.blackColor, fontSize: 17))]),
                              ),
                              Padding(
                                    ...
                                    ? InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [Text('Send OTP'.tr, style: const TextStyle(color: ThemeProvider.whiteColor, fontSize: 17))],
                                          ),
                                        ),
                                      )
                                    : Container(
                                        ...
                                        child: const Row(
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: [
                                            CircularProgressIndicator(color: ThemeProvider.whiteColor),
                                          ],
                                        ),
                                      ),
                              ),
                        ...
                        : Column(
                            children: [
                              Padding(
                                padding: const EdgeInsets.symmetric(vertical: 20),
                                child: Row(children: [Text('Gereate Password'.tr, style: const TextStyle(color: ThemeProvider.blackColor, fontSize: 17))]),
                              ),
                              Padding(
                                padding: const EdgeInsets.symmetric(vertical: 5),
                                child: SizedBox(
                                ...
                                child: value.isLogin.value == false
                                    ? InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            mainAxisAlignment: MainAxisAlignment.center,
                                            children: [Text('Update Password'.tr, style: const TextStyle(color: ThemeProvider.whiteColor, fontSize: 17))],
                                          ),
                                        ),
                                      )
                                    : Container(
                                        ...
                                        padding: const EdgeInsets.symmetric(vertical: 13.0),
                                        decoration: contentButtonStyle(),
                                        child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [CircularProgressIndicator(color: ThemeProvider.whiteColor)]),
                                      ),
                              ),
                            ],
                          ),
