                                                    ...
                                                    Padding(
                                                      ...
                                                      child: ClipRRect(
                                                        ...
                                                        child: SizedBox.fromSize(
                                                          ...
                                                          child: FadeInImage(
                                                            image: NetworkImage('${Environments.apiBaseURL}storage/images/${value.productSalonList[index].userInfo!.cover.toString()}'),
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: ClipRRect(
                                                        ...
                                                        child: SizedBox.fromSize(
                                                          size: const Size.fromRadius(25),
                                                          child: FadeInImage(
                                                            image: NetworkImage('${Environments.apiBaseURL}storage/images/${value.productSalonListOld[index].userInfo!.cover.toString()}'),
                                                            placeholder: const AssetImage("assets/images/placeholder.jpeg"),
                                                            imageErrorBuilder: (context, error, stackTrace) {
                                                              return Image.asset('assets/images/notfound.png', fit: BoxFit.cover, height: 25, width: 25);
                                                            },
