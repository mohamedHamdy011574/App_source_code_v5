                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          Text('${item.firstName}  ${item.lastName}', overflow: TextOverflow.ellipsis, style: const TextStyle(fontFamily: 'bold', fontSize: 14)),
                                          Expanded(
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                InkWell(
                                                  onTap: () => value.onEdit(item.id as int),
