            ...
            child: value.currentView == 1
                ? InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [Text('Next'.tr, style: const TextStyle(color: ThemeProvider.whiteColor, fontSize: 17))]),
                    ),
                  )
                : value.currentView == 2
                    ? Row(
                          ...
                          Expanded(
                            child: SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                child: Text('Previews'.tr, style: const TextStyle(letterSpacing: 1, fontSize: 16, color: ThemeProvider.whiteColor, fontFamily: 'bold')),
                              ),
                            ),
                          ),
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('Select your type'.tr, style: const TextStyle(fontFamily: 'bold', fontSize: 14)),
                        ...
                        GestureDetector(
                          ...
                          child: Padding(
                            ...
                            child: Container(
                              decoration: BoxDecoration(borderRadius: const BorderRadius.all(Radius.circular(10)), border: Border.all(color: ThemeProvider.greyColor)),
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Icon(value.type == 1 ? Icons.check_circle : Icons.circle_outlined, color: value.type == 1 ? ThemeProvider.appColor : ThemeProvider.greyColor),
                                        const SizedBox(width: 10),
                                        Text('Salon'.tr, style: const TextStyle(fontFamily: 'bold', fontSize: 14))
                                      ],
                                    ),
                                    Container(
                                      height: 56,
                                      width: 56,
                                      decoration: const BoxDecoration(image: DecorationImage(image: AssetImage('assets/images/salon.png'), fit: BoxFit.cover)),
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Icon(value.type == 0 ? Icons.check_circle : Icons.circle_outlined, color: value.type == 0 ? ThemeProvider.appColor : ThemeProvider.greyColor),
                                        const SizedBox(width: 10),
                                        Text('Individual'.tr, style: const TextStyle(fontFamily: 'bold', fontSize: 14))
                                      ],
                                    ),
                                    Container(
                                      height: 56,
                                      width: 56,
                                      decoration: const BoxDecoration(image: DecorationImage(image: AssetImage('assets/images/freelancer.png'), fit: BoxFit.cover)),
                                      child: const SizedBox(),
                                    )
                                  ],
                                ),
                                        ...
                                        children: [
                                          ...
                                          Column(
                                            ...
                                            children: List.generate(
                                              ...
                                              (index) => Text(value.servedCategoriesList[index].name.toString()),
                                            ),
                                          )
                                        ],
                                      ),
