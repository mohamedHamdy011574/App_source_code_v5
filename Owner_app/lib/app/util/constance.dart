...
*/
import 'package:owner/app/backend/models/language_model.dart';
...
class AppConstants {
  ...
  static const String getSelectedCategories = 'api/v1/salon/getMySelectedCategory';
  static const String getIndividualCategories = 'api/v1/individual/getMySavedCategory';
  ...
  static const String getAllProductsCate = 'api/v1/product_categories/getActive';
  static const String getSubCateById = 'api/v1/product_sub_categories/getFromCateId';
  static const String createProducts = 'api/v1/products/create';
  static const String getProductWFreelancer = 'api/v1/products/getWithFreelancers';
  ...
  static const String getSalonAppointmentsList = 'api/v1/appoinments/getSalonList';
  static const String getIndividualAppointmentsList = 'api/v1/appoinments/getIndividualList';
  static const String getIndividualOrdersList = 'api/v1/product_order/getIndividualOrders';
  static const String getSalonOrdersList = 'api/v1/product_order/getSalonOrders';
  ...
  static const String getAppointmnetsDetails = 'api/v1/appoinments/getInfoOwner';
