...
class StripePayController extends GetxController implements GetxService {
  ...
  Future<void> createOrderIndividual(dynamic paymentInfo) async {
    ...
    var param = {
      ...
      'wallet_price':
          Get.find<IndividualPaymentController>().isWalletChecked == true && Get.find<IndividualPaymentController>().walletDiscount > 0 ? Get.find<IndividualPaymentController>().walletDiscount : 0,
