...
class ComplaintsParser {
  ...
  ComplaintsParser({required this.sharedPreferencesManager, required this.apiService});

  Future<Response> getOrderDetails(var id) async {
    return await apiService.postPrivate(AppConstants.getProductOrderInfo, {'id': id}, sharedPreferencesManager.getString('token') ?? '');
  }
