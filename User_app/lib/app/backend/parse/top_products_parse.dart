...
class TopProductsParser {
  ...
  TopProductsParser({required this.sharedPreferencesManager, required this.apiService});

  Future<Response> getTopProducts() async {
    var response = await apiService.postPublic(AppConstants.getTopProducts, {"lat": getLat(), "lng": getLng()});
    return response;
  }
