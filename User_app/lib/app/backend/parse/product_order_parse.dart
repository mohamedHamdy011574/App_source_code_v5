...
class ProductOrderParser {
  ...
  ProductOrderParser({required this.apiService, required this.sharedPreferencesManager});

  Future<Response> getProductById() async {
    return await apiService.postPrivate(AppConstants.getProductOrderList, {'id': sharedPreferencesManager.getString('uid')}, sharedPreferencesManager.getString('token') ?? '');
  }
