                                ...
                                value.salonOrderInfo.type == 'salon'
                                    ? Row(
                                        ...
                                        children: [
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  children: [
                                                    Expanded(
                                                      child: Text(value.fullAddres.toString(),
                                                          overflow: TextOverflow.ellipsis, maxLines: 2, style: const TextStyle(fontSize: 11, color: ThemeProvider.blackColor)),
                                                    ),
                                                  ],
                                                ),
                                              ],
                                          ...
                                          IconButton(
                                            onPressed: () => value.onContactInfo(value.salonOrderInfo.salonInfo!.name!, value.salonOrderInfo.ownerInfo!.mobile!, value.salonOrderInfo.ownerInfo!.email!,
                                                value.salonOrderInfo.salonId.toString()),
