...
class _TabScreenState extends State<TabScreen> {
  ...
  Widget build(BuildContext context) {
    List<Widget> pages = const [HomeScreen(), NearScreen(), CategoriesScreen(), BookingScreen(), AccountScreen()];
            ...
            child: Padding(
              ...
              child: InkWell(
                child: (GNav(
                  ...
                  tabs: [
                    GButton(icon: Icons.home_outlined, text: 'Home'.tr, backgroundColor: ThemeProvider.appColor),
                    GButton(icon: Icons.location_on_outlined, text: 'NearBy'.tr, backgroundColor: ThemeProvider.appColor),
                    GButton(
                      ...
                      leading: badges.Badge(
                        ...
                        badgeStyle: badges.BadgeStyle(badgeColor: value.tabId == 2 ? ThemeProvider.whiteColor : ThemeProvider.appColor),
                    ...
                    GButton(icon: Icons.calendar_today_outlined, text: 'Appoinment'.tr, backgroundColor: ThemeProvider.appColor),
