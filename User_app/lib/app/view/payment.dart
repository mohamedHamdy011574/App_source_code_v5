                    ...
                    child: Column(
                      children: [
                        value.salonDetails.serviceAtHome == 1
                            ? Row(mainAxisAlignment: MainAxisAlignment.start, children: [Text('Service at'.tr, style: const TextStyle(fontFamily: 'bold', fontSize: 14))])
                            : const SizedBox(),
                        value.salonDetails.serviceAtHome == 1
                            ? Container(
                                height: 50,
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Row(
                                          ...
                                          children: [
                                            Text('At Home'.tr, overflow: TextOverflow.ellipsis),
                                            Icon(value.appointmentsTo == 1 ? Icons.check_circle : Icons.circle_outlined, color: ThemeProvider.appColor)
                                          ],
                                        ),
                                      ),
                                    ],
                              ...
                              children: [
                                Expanded(
                                  child: value.offerName.isEmpty
                                      ? Text('Apply Coupon Code'.tr, overflow: TextOverflow.ellipsis)
                                      : Text('Coupon Applied :'.tr + value.offerName, overflow: TextOverflow.ellipsis),
                                ),
              ...
              children: [
                value.appointmentsTo == 1
                    ? ListTile(
                        ...
                        minLeadingWidth: 0,
                        title:
                            value.haveAddress == true ? Text('${value.addressInfo.address} ${value.addressInfo.landmark}', style: const TextStyle(fontSize: 14)) : Text('Please Add Your Address'.tr),
                        trailing: const Icon(
                          Icons.edit_outlined,
                          size: 14,
                        ),
