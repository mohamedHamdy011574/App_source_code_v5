    ...
    return GetBuilder<ChooseLocationController>(
      builder: (value) {
        return Scaffold(
          ...
          appBar: AppBar(
              elevation: 0, automaticallyImplyLeading: false, backgroundColor: ThemeProvider.whiteColor, title: const Row(mainAxisAlignment: MainAxisAlignment.end), actions: <Widget>[getLanguages()]),
