...
class _IntroScreenState extends State<IntroScreen> {
    ...
    return GetBuilder<IntroController>(
      builder: (value) {
        return Scaffold(
          ...
          appBar: AppBar(elevation: 0, backgroundColor: ThemeProvider.whiteColor, title: const Row(mainAxisAlignment: MainAxisAlignment.end), actions: <Widget>[getLanguages()]),
  ...
  Widget _buildSlide1(BuildContext context) {
    return Column(
      children: [
        Container(height: 300, decoration: const BoxDecoration(image: DecorationImage(image: AssetImage('assets/sliders/1.png'), fit: BoxFit.contain))),
        Column(
          children: [
            Padding(
              padding: const EdgeInsets.symmetric(vertical: 20),
  ...
  Widget _buildSlide2(BuildContext context) {
    return Column(
      children: [
        Container(height: 300, decoration: const BoxDecoration(image: DecorationImage(image: AssetImage('assets/sliders/2.png'), fit: BoxFit.contain))),
        Column(
          children: [
            Padding(
              padding: const EdgeInsets.symmetric(vertical: 20),
  ...
  Widget _buildSlide3(BuildContext context) {
    return Column(
      children: [
        Container(height: 300, decoration: const BoxDecoration(image: DecorationImage(image: AssetImage('assets/sliders/3.png'), fit: BoxFit.contain))),
        Column(
          children: [
            Padding(
              padding: const EdgeInsets.symmetric(vertical: 20),
  ...
  Widget _buildSlide4(BuildContext context) {
    return Column(
      children: [
        Container(height: 300, decoration: const BoxDecoration(image: DecorationImage(image: AssetImage('assets/sliders/4.png'), fit: BoxFit.contain))),
        Column(
          children: [
            Padding(
              padding: const EdgeInsets.symmetric(vertical: 20),
  ...
  Widget _buildSlide5(BuildContext context) {
    return Column(
      children: [
        Container(height: 300, decoration: const BoxDecoration(image: DecorationImage(image: AssetImage('assets/sliders/5.png'), fit: BoxFit.contain))),
        Column(
          children: [
            Padding(
              padding: const EdgeInsets.symmetric(vertical: 20),
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: (Theme.of(context).brightness == Brightness.dark ? ThemeProvider.whiteColor : ThemeProvider.blackColor).withOpacity(currentIndex == entry.key ? 0.9 : 0.4),
                  ),
                ),
              );
            }).toList(),
        ...
        children: [
          Padding(
            ...
            child: TextButton(
              ...
              child: Center(child: Text('Skip'.tr, style: const TextStyle(fontFamily: 'bold', color: ThemeProvider.blackColor))),
            ),
          ),
          Padding(
            padding: const EdgeInsets.all(10.0),
            child: TextButton(
              ...
              child: Center(child: Text('Next'.tr, style: const TextStyle(fontFamily: 'bold', color: ThemeProvider.appColor))),
            ),
          ),
        ],
      ),
        ...
        children: [
          Padding(
            ...
            child: TextButton(
              ...
              child: Center(child: Text('Previous'.tr, style: const TextStyle(fontFamily: 'bold', color: ThemeProvider.blackColor))),
            ),
          ),
          Padding(
            padding: const EdgeInsets.all(10.0),
      ...
      child: Row(
        ...
        children: [
          ...
          Padding(
            ...
            child: TextButton(
              onPressed: () => Get.toNamed(AppRouter.chooseLocationRoutes),
              child: Center(child: Text('Get Started'.tr, style: const TextStyle(fontFamily: 'bold', color: ThemeProvider.appColor))),
            ),
          ),
        ],
      ),
