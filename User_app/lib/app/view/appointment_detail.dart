                              ...
                              value.appointmentInfo.salonId != 0
                                  ? Row(
                                      ...
                                      children: [
                                        ...
                                        IconButton(
                                          onPressed: () {
                                            value.onContactInfo(value.appointmentInfo.salonInfo!.name!, value.appointmentInfo.ownerInfo!.mobile!, value.appointmentInfo.ownerInfo!.email!,
                                  ...
                                  : Row(
                                      ...
                                      children: [
                                        ...
                                        IconButton(
                                          onPressed: () {
                                            value.onContactInfo('${value.appointmentInfo.ownerInfo!.firstName!} ${value.appointmentInfo.ownerInfo!.lastName!}',
                                                value.appointmentInfo.ownerInfo!.mobile!, value.appointmentInfo.ownerInfo!.email!, value.appointmentInfo.freelancerId.toString());
                                          },
                                          icon: const Icon(Icons.info),
                                          color: ThemeProvider.appColor,
                                        )
